                ...
                <div style="border:1px solid #ccc; padding:20px; border-radius:10px; background-color:#f5deb3;">
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <p><img src="../Instant_Chef_img/pasta-1181189_1280.jpg" alt="料理道具" style="width:75%; height:150px; margin-top: 30px; background-color:#c0c0c0;"></p>     
                ...
                <div style="border:1px solid #ccc; padding:20px; border-radius:10px; background-color:#f5deb3;">
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <p><img src="../Instant_Chef_img/scale-1209837_1920.jpg" alt="料理道具" style="width:75%; height:150px;  margin-top: 30px; background-color:#c0c0c0;"></p>     
                ...
                <div style="border:1px solid #ccc; padding:20px; border-radius:10px; background-color:#f5deb3;">
                    <div class="col-sm-12">
                        <div class="text-center">
                            ...
                            <p><img src="/Instant_Chef_img/platter-2009590_1920.jpg" alt="料理道具" style="width:75%; height:150px; margin-top: 30px; background-color:#c0c0c0;"></p>   
                            ...
                            @else
                                ...
                                {!! link_to_route("recipeList.get", "レシピ一覧を見る", [], ["class" => "btn btn-lg btn-primary", "style" => "background-color: #ff4500; border-style: none; color: #ffffff; width:75%; margin-top:20px; margin-bottom:50px;"]) !!} 
                            @endif
                        </div>
                    </div>
                </div>
