    ...
    <section>
        ...
        <div class="row">
            <div class="offset-sm-4 col-sm-4" style="margin-bottom:50px;">
                {!! link_to_route("recipeInputForm.get", "Provide Recipe Against This Order ", ["id" => $order->id], ["class" => "btn btn-lg btn-primary", "style" => "background-color: #ff4500; border-color: #ffffff; color: #ffffff;  width:100%;"]) !!} 
                {!! link_to_route("allOrderList.get", "BACK", [], ["class" => "btn btn-lg btn-primary", "style" => "background-color: #ff4500; border-color: #ffffff; color: #ffffff;  width:100%;"]) !!}
            </div> 
        </div>
    </section>
@endsection