    ...
    <section class="show">
        ...
        <div class="row">
            <div class="offset-sm-4 col-sm-4">
                {!! link_to_route("myRecipeList.get", "PROVIDED RECIPES", ["id" => $order->id], ["class" => "btn btn-lg btn-primary", "style" => "background-color: #ff4500; border-color: #ffffff; color: #ffffff;  width:100%; margin-bottom:20px;"]) !!}
