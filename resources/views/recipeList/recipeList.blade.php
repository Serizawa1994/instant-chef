                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($recipes as $recipe)
                            @if(!$recipe->user_id == null)
                                @if(Auth::check())
                                    <tr>
                                        <td style="border-left: 3px solid #ff4500; border-right: 3px solid #ff4500;"><span style="font-size:20px;">{!! link_to_route("recipeListShow.get", "$recipe->title", ["id" => $recipe->id]); !!}</span></td>
                                    </tr>
                                    <tr>        
